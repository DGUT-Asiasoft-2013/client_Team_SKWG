...
public class ManageOrderToBeSendFragment extends Fragment {
	View view;
	ListView list;
	...
	public void load(){
		...
		Request request=Server.requestBuilderWithApi("orders/ordersOfSeller/3")
				.get().build();
			...
			public void onResponse(Call arg0, Response arg1) throws IOException {
				getActivity().runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						ManageOrderToBeSendFragment.this.load();
					}
				});
			}
