...
public class BuyActivity extends Activity {
                ...
                Server.getSharedClient().newCall(request).enqueue(new Callback() {
                        ...
                        public void onResponse(Call arg0, final Response arg1) throws IOException {
                                runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                                try {
                                                        BuyActivity.this.defaultInfo = new ObjectMapper().readValue(
                                                                        arg1.body().string(), CommomInfo.class);
                                                        runOnUiThread(new Runnable() {
        ...
        void setInfo() {
                ...
                Log.d("info", defaultInfo.getName() + "   " + defaultInfo.getAddress() + "    " + defaultInfo.getTel()
                                + "   " + defaultInfo.getPostCode());
        }
