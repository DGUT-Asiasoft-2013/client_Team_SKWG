...
public class GoodsPicture extends View{

	public GoodsPicture(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	public GoodsPicture(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public GoodsPicture(Context context) {
		super(context);
	}
	...
	public void load(Shop shop) {
		load(Server.serverAdress + shop.getShopImage());
	}
	@Override
